...
function braillewright_features_add_customizer_content( $wp_customize ) {
	...
	if ( method_exists( 'WP_Customize_Manager', 'add_panel' ) ) {
		...
		$wp_customize->add_panel(
			'braillewright_features_colors_panel',
			array(
				'priority'    => 2,
		...
		$wp_customize->add_panel(
			'braillewright_features_fonts_panel',
			array(
				'priority'    => 3,
		...
		$wp_customize->add_panel(
			'braillewright_features_font_sizes_panel',
			array(
				'priority'    => 4,
		...
		$wp_customize->add_panel(
			'braillewright_features_background_panel',
			array(
				'priority'    => 6,
		...
		$wp_customize->add_panel(
			'braillewright_features_show_hide_panel',
			array(
				'priority'    => 8,
	...
	// section
	$wp_customize->add_section(
		'braillewright_features_background_image',
		array(
	...
	// section
	$wp_customize->add_section(
		'braillewright_features_background_texture',
		array(
